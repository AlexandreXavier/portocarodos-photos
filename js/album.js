(async function () {
  ...
  try {
    ...
    updatePrompt('<p>Algo de Errado .</p><a href="https://github.com/AlexandreXavier/dat-photos-app">Report an issue</a>')
  }
  ...
  function onShare () {
    ...
    updatePrompt(`<div id="close-prompt">Fechar</div><p>Partilhe as tuas fotos URL:</p><p><code>${archive.url}</code></p><p><em>URL copiado para o clipboard</em></p>`)
  ...
  async function renderAlbum () {
    try {
      ...
      updatePrompt('<p>Algo Está Mal</p>')
      console.error(err)
    }
  }

  function renderUAPrompt () {
    updatePrompt('<p>Sorry >.< Esta Aplicação só Trabalha com o Beaker Browser.</p><a class="btn primary" href="https://beakerbrowser.com/docs/install/">Install Beaker</a>')
  }
